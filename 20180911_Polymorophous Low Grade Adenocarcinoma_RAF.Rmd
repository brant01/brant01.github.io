---
title: "NCDB Polymorphous Low Grade Adenocarcinoma "
author: "Ramie Fathy"
...
```{r}
site_code <- c("C069",  "C000" ,  "C001",  "C002",  "C003",  "C004",  "C005",  "C006",  "C007",  "C008", "C019", "C020", "C021", "C022", "C023", "C024", "C028", "C029", "C030", "C031", "C039", "C040", "C041", "C048", "C049","C050", "C051", "c052", "C058", "C059", "C060", "C061", "c062", "C068", "C0680","C0689", "C069", "C090", "C091", "C098", "C099", "C100", "C101", "c102", "C103", "C104", "C108", "C109",  "C110", "C111", "c112", "C113", "C114", "C118", "C119", "C120", "C130", "C131", "c132", "C138", "C139", "c140", "C142", "C148","C300", "C301", "C310", "C311", "c312", "C313", "C318", "C319", "C320", "C321", "c322", "C323", "C328", "C329")
      
# create a new data frame with a column of integers representing the numeric ICD code              
dat2 <- dat%>% mutate(sites = as.integer(substr(PRIMARY_SITE,2,4)))          
others <- dat[c(which(dat2$sites %in% 440:444),which(dat2$sites %in% 490:499),which(dat2$sites %in% 690:699),which(dat2$sites %in% 760:779)),]
otherSiteCodes <- levels(droplevels(others$PRIMARY_SITE))
site_code <- c(site_code, otherSiteCodes)
